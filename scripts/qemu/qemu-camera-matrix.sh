...
echo "Running QEMU camera matrix"
CAMERA_MATRIX_SENSORS="${QEMU_CAMERA_MATRIX_SENSORS:-imx708 imx219 imx477}" \
SKIP_SYNC=1 "${script_dir}/../remote/remote-camera-matrix.sh"

echo
echo "QEMU camera matrix complete."
